...
<div data-role="page">
	...
	<a href="<?php echo base_url() ?>index.php/proyectos/ver/<?php echo $idproyecto ?>" data-icon="delete">Cancelar</a>
		<h1>Nuevo requerimiento</h1>
	</div><!-- /header -->

        <div data-role="content">
            <form method="post" action="<?php echo base_url(); ?>index.php/requerimientos/setnuevo/<?php echo $idproyecto ?>" data-ajax="false" >
